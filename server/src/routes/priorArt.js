...
export default createCrudRoutes('prior_art_analyses', {
  systemPrompt: 'You are an expert prior art analyst for patent applications. Analyze inventions, identify relevant prior art references, assess novelty and non-obviousness, and provide detailed patentability opinions. Return structured JSON when asked.',

...
// Custom Feature: Claim infringement checker
// Claim infringement checker: Given competitor product description, AI analyzes whether your patents likely cover it; flag for licensing opportunities
import React, { useState } from 'react';

export default function CFClaimInfringementCheckerPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-claim-infringement-checker/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Claim infringement checker</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Claim infringement checker: Given competitor product description, AI analyzes whether your patents likely cover it; flag for licensing opportunities</p>

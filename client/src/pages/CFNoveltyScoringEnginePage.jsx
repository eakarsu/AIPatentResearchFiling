...
// Custom Feature: Novelty scoring engine
// Novelty scoring engine: Compare new patent disclosure against aggregated prior art (patents + literature); provide real-time novelty score and highlight problematic claims
import React, { useState } from 'react';

export default function CFNoveltyScoringEnginePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-novelty-scoring-engine/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Novelty scoring engine</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Novelty scoring engine: Compare new patent disclosure against aggregated prior art (patents + literature); provide real-time novelty score and highlight problematic claims</p>

...
// Gap (AI): Infringement without '/infringement
// Infringement without /infringement-risk-score (assess likelihood of infringement lawsuit)
import React, { useState } from 'react';

export default function GapInfringementWithoutInfringementPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-infringement-without-infringement/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Infringement without '/infringement</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Infringement without /infringement-risk-score (assess likelihood of infringement lawsuit)</p>

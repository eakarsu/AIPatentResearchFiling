...
// Custom Feature: International filing optimizer
// International filing optimizer: AI evaluates market size, competition, licensing potential by country; recommends which countries to file PCT and when
import React, { useState } from 'react';

export default function CFInternationalFilingOptimizerPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-international-filing-optimizer/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>International filing optimizer</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>International filing optimizer: AI evaluates market size, competition, licensing potential by country; recommends which countries to file PCT and when</p>

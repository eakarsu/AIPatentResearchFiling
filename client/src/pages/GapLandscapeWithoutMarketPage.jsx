...
// Gap (AI): Landscape without '/market
// Landscape without /market-threat-score (assess competitive patent risk)
import React, { useState } from 'react';

export default function GapLandscapeWithoutMarketPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-landscape-without-market/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Landscape without '/market</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Landscape without /market-threat-score (assess competitive patent risk)</p>

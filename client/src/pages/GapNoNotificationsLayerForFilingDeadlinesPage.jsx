...
// Gap (Non-AI): No notifications layer for filing deadlines
// No notifications layer for filing deadlines
import React, { useState } from 'react';

export default function GapNoNotificationsLayerForFilingDeadlinesPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-notifications-layer-for-filing-deadlines/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No notifications layer for filing deadlines</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No notifications layer for filing deadlines</p>

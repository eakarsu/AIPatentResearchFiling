...
// Gap (Non-AI): No foreign patent coordination (PCT filing, country
// No foreign patent coordination (PCT filing, country-specific strategy)
import React, { useState } from 'react';

export default function GapNoForeignPatentCoordinationPctFilingCountryPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-foreign-patent-coordination-pct-filing-country/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No foreign patent coordination (PCT filing, country</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No foreign patent coordination (PCT filing, country-specific strategy)</p>

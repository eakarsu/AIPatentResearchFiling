...
// Gap (AI): Competitor without '/competitor
// Competitor without /competitor-innovation-track (identify emerging patent trends in market)
import React, { useState } from 'react';

export default function GapCompetitorWithoutCompetitorPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-competitor-without-competitor/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Competitor without '/competitor</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Competitor without /competitor-innovation-track (identify emerging patent trends in market)</p>

...
// Claims without /claim-broadness-score (analyze coverage breadth and litigation risk)
...
export default function GapClaimsWithoutClaimPage() {
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      ...
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Claims without /claim-broadness-score (analyze coverage breadth and litigation risk)</p>

...
// Gap (Non-AI): No licensing marketplace
// No licensing marketplace
import React, { useState } from 'react';

export default function GapNoLicensingMarketplacePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-licensing-marketplace/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No licensing marketplace</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No licensing marketplace</p>
